...
const total = check('MessageList', chat, ['hello there', 'well met', '✎', '↻', 'The fog thickens.', 'She steps closer.', 'msg assistant action grouped'])
  ...
  + check('PresetModal', preset, ['New preset', 'Opening message', 'Story instructions', '+ Add character', 'preset-gen', 'Generate from a description', 'Nothing is saved until you press Save'])
