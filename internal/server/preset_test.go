...
func TestGenerationOptionsAreGlobal(t *testing.T) {
	...
	if rec := putConfig(t, srv, `{"model":"global/model","temperature":0.5,"maxTokens":777,"maxSteps":4,"reasoningEffort":"low","choicesEnabled":true,"disabledTools":["writing_block"]}`); rec.Code != http.StatusOK {
